...
-- *******|************|********************|*****************************************************************************
--  01    | 04-12-2025 | Arjan de Ruijter   | Database met de hoogste achtbanen van Europa
-- -----------------------------------------------------------------------------------------------------------------------
...
-- Versie | Datum      | Auteur             | Omschrijving
-- *******|************|********************|*****************************************************************************
--  01    | 04-12-2025 | Arjan de Ruijter   | Tabel met de hoogste achtbanen van Europa
-- -----------------------------------------------------------------------------------------------------------------------
...
(
    ...
    Remark              VARCHAR(255)      NULL     COMMENT 'Optional remark or additional information',
...
-- Versie | Datum      | Auteur             | Omschrijving
-- *******|************|********************|*****************************************************************************
--  01    | 04-12-2025 | Arjan de Ruijter   | Vul tabel hoogste achtbanen van Europa
-- -----------------------------------------------------------------------------------------------------------------------
