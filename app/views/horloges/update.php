        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogeController/update/<?= $data['horloge']->Id; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" max="999999" step="0.01" id="prijs"
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" max="9999" step="0.01" id="gewicht"
                ...
                <div class="mb-3">
                    ...
                    <input name="waterdichtheid" type="text" id="waterdichtheid"
                ...
                <div class="mb-3">
                    ...
                    <input name="uniekkenmerk" type="text" id="uniekkenmerk"
